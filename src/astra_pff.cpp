...
{    
    ...
    if(!nh.getParam("/astra_pff/robot_height",robotheight)){robotheight = 0.4;}
    if(!nh.getParam("/astra_pff/sensor_height",sensorheight)){sensorheight = 0.16;}
    if(!nh.getParam("/astra_pff/resolution",resolution)){resolution = 0.4;}
